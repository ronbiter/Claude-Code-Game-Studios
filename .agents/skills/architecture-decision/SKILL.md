...
4.6. **Technical Director Strategic Review** — After the engine specialist validation, spawn `technical-director` via task using gate **TD-ADR** (`.agents/docs/director-gates.md`):
