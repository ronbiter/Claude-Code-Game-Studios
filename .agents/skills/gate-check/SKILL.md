...
- **No accessibility requirements doc?** → Use `question` to offer to create it now:
  ...
  - Then write `design/accessibility-requirements.md` using the template at `.agents/docs/templates/accessibility-requirements.md`, filling in the chosen tier. Confirm: "May I write `design/accessibility-requirements.md`?"
